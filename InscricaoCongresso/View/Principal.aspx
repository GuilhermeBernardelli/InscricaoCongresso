...
&nbsp;<asp:Label ID="lblLocalTrabalho" runat="server" Text="Local de trabalho/estudo : "></asp:Label>
                <asp:TextBox ID="TextBox7" runat="server" Width="252px"></asp:TextBox>
                <br />
                <br />
                &nbsp;<asp:Label ID="lblSituacaoFormacao" runat="server" Text=" Situação atual dos estudos : "></asp:Label>
                <asp:TextBox ID="TextBox8" runat="server" Width="587px"></asp:TextBox>
                <br />
        ...
        <asp:Panel ID="pnlTrabalho" runat="server" Height="380px" CssClass="left" Visible="False" GroupingText="Trabalho acadêmico" HorizontalAlign="Left">
            <br />
        ...
        <asp:Panel ID="Panel2" runat="server" Height="67px" Width="100%" >
